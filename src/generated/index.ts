...
export const useInfiniteUsersQuery = <TData = UsersQuery, TError = unknown>(
...
export const useUserDetailsQuery = <TData = UserDetailsQuery, TError = unknown>(
  ...
  useQuery<UserDetailsQuery, TError, TData>(
    ...
    fetcher<UserDetailsQuery, UserDetailsQueryVariables>(
      client,
...
export const useTasksQuery = <TData = TasksQuery, TError = unknown>(
  ...
  useQuery<TasksQuery, TError, TData>(
    ...
    fetcher<TasksQuery, TasksQueryVariables>(
      client,
      TasksQueryDocument,
      variables,
      headers
...
export const useInfiniteTasksQuery = <TData = TasksQuery, TError = unknown>(
...
export const TaskDetailsQueryDocument = `
  ...
  task(where: {id: {_eq: $id}}) {
    ...
    ${TaskDetailsFragment}
${UserDetailsFragment}`
export const useTaskDetailsQuery = <TData = TaskDetailsQuery, TError = unknown>(
  client: GraphQLClient,
  ...
  useQuery<TaskDetailsQuery, TError, TData>(
    ...
    fetcher<TaskDetailsQuery, TaskDetailsQueryVariables>(
      client,
      TaskDetailsQueryDocument,
      variables,
      headers
    ),
    options
